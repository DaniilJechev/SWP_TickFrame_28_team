# Assignment 6 — Issue Template

> Use this template for every Sprint 5 (Week 6) and Sprint 6 (Week 7) issue. Fill out all applicable sections.
...
| Field | Instructions |
|---|---|
| **Title** | `{PBI-XXX} Short description` or `US-XX Short description` or `DOC: short description` or `TRA: short description` |
| **Type** | Enhancement / Bug / Documentation / Testing / Architecture / Course Task / Transition |
| **Sprint** | [Sprint 5 (Week 6)](https://github.com/Fedos113/SWP_TickFrame_28_team/milestone/6) or [Sprint 6 — MVP v3 (Week 7)](https://github.com/Fedos113/SWP_TickFrame_28_team/milestone/7) |
| **Backlog Location** | Product Backlog → Sprint 5 or Sprint 6 section in [`docs/backlog.md`](../../docs/backlog.md) |
| **MVP Version** | `MVP v3` |
...
_What is this issue about? Why does it matter for MVP v3, customer handover, transition, or Assignment 6?_
...
## Links to Assignment 6 Artifacts
...
- [ ] Relevant documentation updated (architecture, ADR, testing, DoD, quality, customer-handover)
