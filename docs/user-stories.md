...
|---|---|---|---|---|---|---|
| US-01 | Detect chart patterns with ML support | Must Have | [#005](https://github.com/Fedos113/SWP_TickFrame_28_team/issues/5) | Active | To Do | - |
...
| US-06 | Sidebar with 10 trading pairs and actual prices | Must Have | [#015](https://github.com/Fedos113/SWP_TickFrame_28_team/issues/15) | Active | To Do | — |
| US-07 | Choose timeframes of the chart | Must Have | [#018](https://github.com/Fedos113/SWP_TickFrame_28_team/issues/18) | Active | To Do | — |
...
> Notes:
> - Add one row per active story, ordered by MoSCoW priority, then by Sprint, then by stable ID.
> - Keep removed stories at the bottom with `Requirement status: Removed` and no issue link if no issue is needed.
> - Do not duplicate full story text here; use issue links for detail.
