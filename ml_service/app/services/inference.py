import numpy as np
from app.config import THRESHOLD_CLASSIC_HS, THRESHOLD_INVERSE_HS, TOLERANCE_WINDOW
...
def apply_nms_clustering(y_pred: np.ndarray, probas: np.ndarray) -> np.ndarray:
    """
